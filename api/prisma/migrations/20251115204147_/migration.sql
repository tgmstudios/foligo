/*
  ...
  - A unique constraint covering the columns `[ssoProviderId,ssoSubject]` on the table `users` will be added. If there are existing duplicate values, this will fail.

*/
-- AlterTable
ALTER TABLE "users" ADD COLUMN     "ssoProviderId" TEXT,
