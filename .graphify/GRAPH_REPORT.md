...
## Corpus Check
- 383 files · ~335,008 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1913 nodes · 4159 edges · 112 communities detected
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 25 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: MODIFIES: 1461 · contains: 1154 · imports_from: 387 · PARENT_OF: 316 · ON_BRANCH: 304 · imports: 274 · calls: 106 · method: 65 · references: 53 · re_exports: 12 · uses: 6 · inherits: 3 · accesses: 1 · built_with: 1 · connects_to: 1 · consumes: 1 · deployed_with: 1 · edits: 1 · enables: 1 · entry_point: 1 · generates: 1 · handles: 1 · implemented_by: 1 · implements: 1 · includes: 1 · orchestrates: 1 · related_to: 1 · serves: 1 · tracks: 1 · ui_for: 1


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 383 · Candidates: 508
- Excluded: 0 untracked · 121928 ignored · 1 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `bbb2aec`
...
Cohesion: 0.06
Nodes (43): bcryptjs, client, 1596c73 Voice mode, 16a008d Dark mode, 2437013 media library changes, 245df8e Merge branch 'main' of https://github.com/tgmstudios/foligo, 27c2bf1 feat: add analytics and content similarity, 29df55c AI Multistep (+35 more)
...
Cohesion: 0.03
Nodes (77): connectDatabase(), connectRedis(), cors, express_rate_limit, helmet, morgan, publicRouter, router (+69 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (48): 0702c3b fix(sse): prevent QUIC/HTTP3 connection drops on long AI responses, 40a5f9c feat: bump all agent maxSteps from 6-8 to 30-40 turns, b5a50cc fix(latex): parse tectonic inline error format + detect microtype/XeTeX conflict, ai, { body, validationResult }, { cache }, { createContentEditorTools }, { createGithubTools } (+40 more)
...
Cohesion: 0.07
Nodes (9): 02cf9b1 feat(dashboard): add job categories/tags, search/sort, and address/phone inputs to GoApply, 2736250 feat(dashboard): support resume templates and defaults in the Resume Gallery, 3725b15 Move old content, 46be3c0 feat: GoApply — kanban, jobs, device auth, dashboard pages, extension login, 9030aa4 Move old content, ca272cd feat(dashboard): support resume templates and defaults in the Resume Gallery, e428e58 feat(dashboard): add job categories/tags, search/sort, and address/phone inputs to GoApply, clearPreferenceCookie() (+1 more)

### Community 10 - "Community 10"
Cohesion: 0.09
Nodes (25): analytics_events, analytics_properties, projects, voice_providers, cleanString(), createWriteKey(), crypto, hash() (+17 more)
...
Cohesion: 0.09
Nodes (23): { authorizeProjectAccess, authenticateToken }, { body, validationResult }, { cache }, express, { findSimilarPostPairs }, geminiService, mammoth, { matchOrCreateSkills, matchOrCreateTags } (+15 more)
...
Cohesion: 0.08
Nodes (3): 00d5f02 feat(goapply): truncate kanban notes, add search filter to cover letters & resumes, enhance badges, bbb2aec feat(goapply): show and filter by linked job category on resumes and cover letters, cfb6e19 feat(goapply): add sort and filtering to resume, cover letter, and Q&A tabs
...
Cohesion: 0.09
Nodes (18): ALLOWED_KEYS, express, { prisma }, { requireAdmin }, router, express, { prisma }, { requireAdmin } (+10 more)

### Community 26 - "Community 26"
Cohesion: 0.10
Nodes (17): { body, validationResult }, { encrypt, decrypt }, express, http, https, { prisma }, { requireAdmin }, router (+9 more)
...
Cohesion: 0.12
Nodes (14): handleFunctionCall(), { AI_RESUME_CHATBOT_TOOLS }, { buildResumeChatbotSystemPrompt }, { createGithubTools }, { GeminiAPIError }, { GENERATION_CONFIG }, { handleFunctionCall }, AI_RESUME_CHATBOT_TOOLS (+6 more)
...
Cohesion: 0.18
Nodes (11): createCoverLetterEditorTools(), { createWebSearchTool }, { tool }, { z }, createResumeEditorTools(), { createWebSearchTool }, { tool }, { z } (+3 more)
...
Cohesion: 0.17
Nodes (7): { createWebSearchTool }, optionalText, profileSchema, { projectAccessWhere }, { tool }, { z }, projectAccessWhere()
...
Cohesion: 0.28
Nodes (7): compile(), crypto, os, parseLatexErrors(), path, runLuaLatex(), { spawn }
...
Cohesion: 0.40
Nodes (3): platform_settings, 2533f8f feat(editor-studio): rich compile errors + LaTeX/markdown linting, f0b501b feat: add web_search tool to all Foligo agents + admin settings
...
## Knowledge Gaps
- **617 isolated node(s):** `content_links`, `sso_providers`, `ai_models`, `voice_providers`, `platform_settings` (+612 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 17`** (1 nodes): `GeminiService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (1 nodes): `AIManager`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 59`** (1 nodes): `SiteApiService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 73`** (1 nodes): `declaration`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 84`** (2 nodes): `flattenToolMessages()`, `{ flattenToolMessages }`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 86`** (1 nodes): `TemplateSelector`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 101`** (2 nodes): `loadEnvForm()`, `toggleCustomFields()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 102`** (2 nodes): `user_integrations`, `users`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 103`** (2 nodes): `Chrome Extension (GoApply)`, `Job Tracker (GoApply)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 104`** (2 nodes): `Docker Deployment`, `MinIO Media Storage`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 105`** (2 nodes): `JWT Authentication`, `SSO/OAuth Authentication`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 106`** (2 nodes): `PostgreSQL Database`, `Prisma ORM`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 107`** (2 nodes): `Rate Limiting`, `Redis Caching`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 108`** (1 nodes): `docxtemplater`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 109`** (1 nodes): `generative_ai`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 110`** (1 nodes): `http`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 111`** (1 nodes): `https`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 112`** (1 nodes): `mammoth`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 113`** (1 nodes): `minio`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 114`** (1 nodes): `openid_client`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 115`** (1 nodes): `pdf_parse`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 116`** (1 nodes): `pizzip`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 117`** (1 nodes): `redis`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 118`** (1 nodes): `uuid`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 119`** (1 nodes): `winston`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `GeminiService` connect `Community 17` to `Community 23`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `prisma` connect `Community 4` to `Community 49`, `Community 8`, `Community 25`, `Community 26`, `Community 15`, `Community 50`, `Community 40`, `Community 37`, `Community 23`, `Community 64`, `Community 60`, `Community 3`, `Community 24`, `Community 21`, `Community 6`, `Community 80`, `Community 19`, `Community 48`, `Community 31`, `Community 13`, `Community 16`, `Community 2`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `AIManager` connect `Community 41` to `Community 46`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.055193394176445025 - nodes in this community are weakly interconnected._
