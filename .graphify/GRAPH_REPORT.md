...
- Excluded: 0 untracked · 121922 ignored · 1 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `cfb6e19`
...
Cohesion: 0.09
Nodes (25): analytics_properties, analytics_events, voice_providers, projects, crypto, hash(), createWriteKey(), normalizeOrigin() (+17 more)
...
Cohesion: 0.09
Nodes (18): jwt, crypto, { prisma }, requireAdmin(), express, { prisma }, { requireAdmin }, router (+10 more)
...
Cohesion: 0.10
Nodes (17): express, { body, validationResult }, { prisma }, { requireAdmin }, { encrypt, decrypt }, https, http, router (+9 more)
...
Cohesion: 0.04
Nodes (48): express, { body, validationResult }, { prisma }, { cache }, ai, { createContentEditorTools }, { createGithubTools }, { setupSSE } (+40 more)
...
Cohesion: 0.18
Nodes (11): { tool }, { z }, { createWebSearchTool }, createCoverLetterEditorTools(), { tool }, { z }, { createWebSearchTool }, createResumeEditorTools() (+3 more)

### Community 53 - "Community 53"
Cohesion: 0.17
Nodes (7): { tool }, { z }, { projectAccessWhere }, { createWebSearchTool }, optionalText, profileSchema, projectAccessWhere()
...
Cohesion: 0.08
Nodes (6): 19d43b2 fix(api): clean up cover letter PDFs on delete, describe LaTeX to the assistant, 6fbbcc1 fix(dashboard): make the Studio preview toggle reachable on mobile, add collapsible chat, b0924e1 refactor(dashboard): always sync Content Studio preview scroll with editor, 347793b refactor(dashboard): always sync Content Studio preview scroll with editor, 532eb3c fix(dashboard): make the Studio preview toggle reachable on mobile, add collapsible chat, ee19071 fix(api): clean up cover letter PDFs on delete, describe LaTeX to the assistant
...
Cohesion: 0.13
Nodes (3): 09d0f94 compiler: switch from tectonic (XeTeX) to LuaLaTeX, c829b84 fix(ai): fix ReferenceError crash from undefined cleanup() call in extension-agent turn route, cfb6e19 feat(goapply): add sort and filtering to resume, cover letter, and Q&A tabs

### Community 7 - "Community 7"
Cohesion: 0.11
Nodes (22): AgentController, GoApplyAPI, Banners, Boards, ChatPanel, Consent, Detector, Filler (+14 more)
...
- **Thin community `Community 104`** (2 nodes): `user_integrations`, `users`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 15`** (1 nodes): `GeminiService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 40`** (1 nodes): `AIManager`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 85`** (2 nodes): `flattenToolMessages()`, `{ flattenToolMessages }`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 74`** (1 nodes): `declaration`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 103`** (2 nodes): `loadEnvForm()`, `toggleCustomFields()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 87`** (1 nodes): `TemplateSelector`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 60`** (1 nodes): `SiteApiService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 110`** (1 nodes): `docxtemplater`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 111`** (1 nodes): `generative_ai`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 112`** (1 nodes): `http`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 113`** (1 nodes): `https`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 114`** (1 nodes): `mammoth`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 115`** (1 nodes): `minio`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 116`** (1 nodes): `openid_client`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 117`** (1 nodes): `pdf_parse`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 118`** (1 nodes): `pizzip`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 119`** (1 nodes): `redis`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 120`** (1 nodes): `uuid`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 121`** (1 nodes): `winston`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 107`** (2 nodes): `JWT Authentication`, `SSO/OAuth Authentication`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 105`** (2 nodes): `Job Tracker (GoApply)`, `Chrome Extension (GoApply)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 106`** (2 nodes): `MinIO Media Storage`, `Docker Deployment`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 109`** (2 nodes): `Redis Caching`, `Rate Limiting`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 108`** (2 nodes): `Prisma ORM`, `PostgreSQL Database`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `GeminiService` connect `Community 15` to `Community 22`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `prisma` connect `Community 4` to `Community 49`, `Community 8`, `Community 24`, `Community 25`, `Community 12`, `Community 50`, `Community 39`, `Community 36`, `Community 22`, `Community 65`, `Community 61`, `Community 3`, `Community 23`, `Community 19`, `Community 6`, `Community 81`, `Community 18`, `Community 48`, `Community 30`, `Community 13`, `Community 14`, `Community 2`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `AIManager` connect `Community 40` to `Community 46`?**
