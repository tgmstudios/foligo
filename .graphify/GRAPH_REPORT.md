...
- Excluded: 6 untracked · 121988 ignored · 1 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `b9a78d3`
...
Cohesion: 0.07
Nodes (36): analytics_properties, analytics_events, voice_providers, projects, express, { Prisma }, { authorizeProjectAccess }, {
  MAX_BATCH_SIZE,
  hash,
  createWriteKey,
  normalizeOrigin,
...
Cohesion: 0.15
Nodes (4): platform_settings, declaration, 2533f8f feat(editor-studio): rich compile errors + LaTeX/markdown linting, f0b501b feat: add web_search tool to all Foligo agents + admin settings

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (43): { PrismaClient }, prisma, { PrismaClient }, bcrypt, prisma, crypto, MERMAID_THEME_VARIABLES, router (+35 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (76): express, path, cors, helmet, morgan, rateLimit, swaggerUi, swaggerJsdoc (+68 more)
...
Cohesion: 0.08
Nodes (24): express, { body, validationResult }, multer, mammoth, pdfParseModule, { prisma }, { cache }, { authorizeProjectAccess, authenticateToken } (+16 more)

### Community 26 - "Community 26"
Cohesion: 0.12
Nodes (17): express, router, ai, { authenticateToken }, { prisma }, { createExtensionAgentServerTools, CLIENT_AGENT_TOOL_DEFS }, { flattenToolMessages }, { setupSSE } (+9 more)
...
Cohesion: 0.12
Nodes (14): handleFunctionCall(), { GeminiAPIError }, { AI_RESUME_CHATBOT_TOOLS }, { createGithubTools }, { buildResumeChatbotSystemPrompt }, { GENERATION_CONFIG }, { handleFunctionCall }, { tool } (+6 more)
...
Cohesion: 0.12
Nodes (10): aim, goapplyRoutes, 933e05e AI Fixes, deepseek support, AI Merged into goapply, c371019 More AI Repairs, ded6ded Agentic editor and PDF Latex support, 7aa68eb Agentic editor and PDF Latex support, 8dcf942 AI Fixes, deepseek support, AI Merged into goapply, bde1fd9 More AI Repairs (+2 more)
...
Cohesion: 0.10
Nodes (16): { tool }, { z }, { createJobAssistantTools, jobAssistantTool }, { generateCoverLetter, generateCustomAnswer }, createExtensionAgentServerTools(), CLIENT_AGENT_TOOL_DEFS, { tool }, { z } (+8 more)
...
Cohesion: 0.15
Nodes (13): { tool }, { z }, { createWebSearchTool }, { createPullPageTool }, createCoverLetterEditorTools(), { tool }, { z }, { createWebSearchTool } (+5 more)

### Community 69 - "Community 69"
Cohesion: 0.28
Nodes (7): { spawn }, os, path, crypto, parseLatexErrors(), compile(), runLuaLatex()
...
Cohesion: 0.07
Nodes (9): readPreferenceCookie(), clearPreferenceCookie(), 02cf9b1 feat(dashboard): add job categories/tags, search/sort, and address/phone inputs to GoApply, 3725b15 Move old content, 46be3c0 feat: GoApply — kanban, jobs, device auth, dashboard pages, extension login, ca272cd feat(dashboard): support resume templates and defaults in the Resume Gallery, 2736250 feat(dashboard): support resume templates and defaults in the Resume Gallery, 9030aa4 Move old content (+1 more)

### Community 28 - "Community 28"
Cohesion: 0.11
Nodes (7): 19d43b2 fix(api): clean up cover letter PDFs on delete, describe LaTeX to the assistant, 648453e feat(studio): add draggable resizing for editor/preview split and chat sidebar, 6fbbcc1 fix(dashboard): make the Studio preview toggle reachable on mobile, add collapsible chat, b0924e1 refactor(dashboard): always sync Content Studio preview scroll with editor, 347793b refactor(dashboard): always sync Content Studio preview scroll with editor, 532eb3c fix(dashboard): make the Studio preview toggle reachable on mobile, add collapsible chat, ee19071 fix(api): clean up cover letter PDFs on delete, describe LaTeX to the assistant
...
Cohesion: 0.07
Nodes (6): AgentController, 00d5f02 feat(goapply): truncate kanban notes, add search filter to cover letters & resumes, enhance badges, b9a78d3 fix(extension): raise agent continuation limit from 20 to 100, bbb2aec feat(goapply): show and filter by linked job category on resumes and cover letters, cfb6e19 feat(goapply): add sort and filtering to resume, cover letter, and Q&A tabs, f14f99d fix(goapply): source resume/cover letter category filter from all jobs

### Community 11 - "Community 11"
Cohesion: 0.11
Nodes (21): GoApplyAPI, Banners, Boards, ChatPanel, Consent, Detector, Filler, Finder (+13 more)
...
## Knowledge Gaps
- **624 isolated node(s):** `content_links`, `sso_providers`, `ai_models`, `voice_providers`, `platform_settings` (+619 more)
...
- **Thin community `Community 85`** (1 nodes): `TemplateSelector`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 60`** (1 nodes): `SiteApiService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 104`** (2 nodes): `JWT Authentication`, `SSO/OAuth Authentication`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 102`** (2 nodes): `Job Tracker (GoApply)`, `Chrome Extension (GoApply)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 103`** (2 nodes): `MinIO Media Storage`, `Docker Deployment`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 106`** (2 nodes): `Redis Caching`, `Rate Limiting`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 105`** (2 nodes): `Prisma ORM`, `PostgreSQL Database`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `prisma` connect `Community 4` to `Community 50`, `Community 9`, `Community 8`, `Community 14`, `Community 51`, `Community 26`, `Community 37`, `Community 23`, `Community 65`, `Community 61`, `Community 3`, `Community 24`, `Community 20`, `Community 7`, `Community 80`, `Community 19`, `Community 48`, `Community 31`, `Community 15`, `Community 6`, `Community 16`, `Community 2`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `AIManager` connect `Community 41` to `Community 47`?**
