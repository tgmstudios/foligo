...
- Excluded: 1 untracked · 119689 ignored · 1 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `b0436f7`
...
Cohesion: 0.03
Nodes (72): { cache }, express, geminiService, { prisma }, router, 07b32b9 refactor(api): reorganize routes/ into domain subfolders, 4bdce87 refactor(api): reorganize services/ into domain subfolders, { authorizeProjectAccess } (+64 more)
...
Cohesion: 0.06
Nodes (63): main, 0210da7 fix: use --no-frozen-lockfile to allow pnpm to resolve build scripts, 02f5b3e fix: move jobs/reorder route before jobs/:id, 0692194 fix: add onlyBuiltDependencies to .npmrc for pnpm 10+ compat, 09f486f fix: install Tectonic on arm64 builds, 150821f remove old code, 156116a dashboard fix, 18576fb fix: Dockerfile monorepo context for pnpm-lock.yaml (+55 more)
...
Cohesion: 0.06
Nodes (54): feat/goapply-workflow-resilience, 00d5f02 feat(goapply): truncate kanban notes, add search filter to cover letters & resumes, enhance badges, 046ebb7 fix(api): retry Tectonic bundle warmup, 0498826 tsc, 07ab9dc fixed, 09d0f94 compiler: switch from tectonic (XeTeX) to LuaLaTeX, 0b81330 refactor(api): rename session-flow.js → ai-session.js, 0fa26e1 ci: speed up ARM64 API builds (+46 more)
...
Cohesion: 0.05
Nodes (38): ALLOWED_KEYS, express, { prisma }, { requireAdmin }, router, express, { prisma }, { requireAdmin } (+30 more)
...
Cohesion: 0.16
Nodes (22): 16a008d Dark mode, 27047d5 readme, 27c2bf1 feat: add analytics and content similarity, 29df55c AI Multistep, 2b50442 Merge branch 'main' of https://github.com/tgmstudios/foligo, 40faf8f Script and Start html files, 743a9d0 feat: add analytics and content similarity, 81238cb Dashboard improvements (+14 more)
...
Cohesion: 0.07
Nodes (29): { authorizeProjectAccess }, { body }, { cache }, express, { getContentWithAccess, invalidateContentCache }, { handleValidation }, { prisma }, router (+21 more)
...
Cohesion: 0.10
Nodes (12): 089f74b Refresh AI-edited posts and experience roles, 09d09b4 feat(ai): add attachment support across editors, raise agent token budgets, 1463ae4 feat(ai): give AI Content Creator full portfolio control, 19d3d7b Update portable graphify artifacts, 8bbadc1 Add persistent AI chat sessions and analytics updates, 9fde3b9 Refresh views after AI content changes, a446f43 feat(dashboard): rebuild Job Assistant as a session workspace on shared agentic chat, cf26e1d feat(ai): extend AI Content Creator to GoApply and add current-page awareness (+4 more)
...
Cohesion: 0.12
Nodes (16): platform_settings, 2d971a7 feat(analytics): add hosted tracking script and dashboard embed snippet, f0b501b feat: add web_search tool to all Foligo agents + admin settings, createCoverLetterEditorTools(), { createPullPageTool }, { createWebSearchTool }, { tool }, { z } (+8 more)

### Community 32 - "Community 32"
Cohesion: 0.12
Nodes (8): 02cf9b1 feat(dashboard): add job categories/tags, search/sort, and address/phone inputs to GoApply, 2736250 feat(dashboard): support resume templates and defaults in the Resume Gallery, ca272cd feat(dashboard): support resume templates and defaults in the Resume Gallery, e428e58 feat(dashboard): add job categories/tags, search/sort, and address/phone inputs to GoApply, clearPreferenceCookie(), parsePreference(), readPreferenceCookie(), writePreferenceCookie()
...
Cohesion: 0.10
Nodes (6): 036dc3f fix(dashboard): build canvas from source in Alpine, 53cc332 Improve AI chats and persist GoApply filters, b0436f7 Graphify artifacts, c8cf150 fix(extension): stop job tracking from overwriting unrelated cards, fef94d7 fix(extension): retain application state across confirmation redirects, AgentController
...
Cohesion: 0.13
Nodes (3): 347793b refactor(dashboard): always sync Content Studio preview scroll with editor, 532eb3c fix(dashboard): make the Studio preview toggle reachable on mobile, add collapsible chat, ee19071 fix(api): clean up cover letter PDFs on delete, describe LaTeX to the assistant
...
Cohesion: 0.24
Nodes (8): 2437013 media library changes, 40fd685 other options, baaf15e social media and better ai chatbot experience, c47de3e New AI resume generator and site-wide touch ups, d348800 migration drift, e3ac367 social media and better ai chatbot experience, e966c80 New AI resume generator and site-wide touch ups, f0d2a2e media library changes
...
Cohesion: 1.00
Nodes (2): ai_chat_sessions, users
...
- **Thin community `Community 45`** (1 nodes): `AIManager`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 47`** (2 nodes): `648453e feat(studio): add draggable resizing for editor/preview split and chat sidebar`, `bbb2aec feat(goapply): show and filter by linked job category on resumes and cover letters`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 61`** (1 nodes): `SiteApiService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 65`** (2 nodes): `3725b15 Move old content`, `9030aa4 Move old content`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 72`** (1 nodes): `config`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 106`** (2 nodes): `user_integrations`, `users`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 107`** (2 nodes): `ai_chat_sessions`, `users`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 108`** (2 nodes): `Chrome Extension (GoApply)`, `Job Tracker (GoApply)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 109`** (2 nodes): `Docker Deployment`, `MinIO Media Storage`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 110`** (2 nodes): `JWT Authentication`, `SSO/OAuth Authentication`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 111`** (2 nodes): `PostgreSQL Database`, `Prisma ORM`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 112`** (2 nodes): `Rate Limiting`, `Redis Caching`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 113`** (1 nodes): `docxtemplater`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 114`** (1 nodes): `generative_ai`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 115`** (1 nodes): `http`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 116`** (1 nodes): `https`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 117`** (1 nodes): `mammoth`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 118`** (1 nodes): `minio`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 119`** (1 nodes): `openid_client`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 120`** (1 nodes): `pdf_parse`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 121`** (1 nodes): `pizzip`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 122`** (1 nodes): `redis`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 123`** (1 nodes): `uuid`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 124`** (1 nodes): `winston`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `prisma` connect `Community 1` to `Community 29`, `Community 11`, `Community 8`, `Community 67`, `Community 27`, `Community 14`, `Community 10`, `Community 28`, `Community 63`, `Community 3`, `Community 20`, `Community 26`, `Community 17`, `Community 38`, `Community 24`, `Community 91`, `Community 34`, `Community 13`, `Community 39`, `Community 19`, `Community 2`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `GeminiService` connect `Community 21` to `Community 28`?**
...
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.03321123321123321 - nodes in this community are weakly interconnected._
