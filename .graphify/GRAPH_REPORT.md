...
- Excluded: 0 untracked · 122091 ignored · 1 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `cf26e1d`
...
Cohesion: 0.04
Nodes (63): { cache }, express, geminiService, { prisma }, router, 07b32b9 refactor(api): reorganize routes/ into domain subfolders, 4bdce87 refactor(api): reorganize services/ into domain subfolders, { authorizeProjectAccess } (+55 more)
...
Cohesion: 0.04
Nodes (48): 0702c3b fix(sse): prevent QUIC/HTTP3 connection drops on long AI responses, 3a97bc9 fix(ai): fix undefined sendSse/cleanup crash in all SSE chat routes, 40a5f9c feat: bump all agent maxSteps from 6-8 to 30-40 turns, b5a50cc fix(latex): parse tectonic inline error format + detect microtype/XeTeX conflict, ai, { body, validationResult }, { cache }, { createContentEditorTools } (+40 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (50): main, 0498826 tsc, 09d0f94 compiler: switch from tectonic (XeTeX) to LuaLaTeX, 09f486f fix: install Tectonic on arm64 builds, 0b81330 refactor(api): rename session-flow.js → ai-session.js, 0fa26e1 ci: speed up ARM64 API builds, 2226c00 prod entrypoint, 26637c3 refactor(api): split projects.js into projects-crud/site-config (Phase 3) (+42 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (22): resume_documents, resume_score_results, allowedScopes, { body, query, validationResult }, express, { prisma }, router, 170fb21 fix: allow empty experience role end dates (+14 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (36): ai, { authorizeProjectAccess, authenticateToken }, { body, validationResult }, { cache }, { createPortfolioAgentTools }, CURRENT_PAGE_LABELS, express, { findSimilarPostPairs } (+28 more)
...
Cohesion: 0.06
Nodes (35): { authorizeProjectAccess }, { body }, { cache }, express, { getContentWithAccess, invalidateContentCache }, { handleValidation }, { prisma }, router (+27 more)
...
Cohesion: 0.13
Nodes (12): 2f0b6d3 SSO support, 3725b15 Move old content, 48d46c3 SSO support, 5944c16 Refactored the content editor to use the new Editor Studio. Refactored admin dashboard, 9030aa4 Move old content, ae8be0a Refactored the content editor to use the new Editor Studio. Refactored admin dashboard, crypto, MERMAID_THEME_VARIABLES (+4 more)
...
Cohesion: 0.12
Nodes (18): 150821f remove old code, 1596c73 Voice mode, 2437013 media library changes, 245df8e Merge branch 'main' of https://github.com/tgmstudios/foligo, 27c2bf1 feat: add analytics and content similarity, 29df55c AI Multistep, 4286262 good ai, 743a9d0 feat: add analytics and content similarity (+10 more)
...
Cohesion: 0.11
Nodes (21): GENERATION_CONFIG, SYSTEM_INSTRUCTIONS, buildMetadataFromStructuredData(), { cleanGeneratedContent }, extractMetadataBasic(), extractMetadataFromConversation(), extractStructuredData(), extractStructuredDataUniversal() (+13 more)

### Community 27 - "Community 27"
Cohesion: 0.10
Nodes (10): ai_chat_sessions, users, 1463ae4 feat(ai): give AI Content Creator full portfolio control, 38dc01a fix(dashboard): remove AI studio test animation, 8bbadc1 Add persistent AI chat sessions and analytics updates, a446f43 feat(dashboard): rebuild Job Assistant as a session workspace on shared agentic chat, d082103 feat(dashboard): rebuild Job Assistant as a session workspace on shared agentic chat, AgenticChatCallbacks (+2 more)
...
Cohesion: 0.25
Nodes (12): 16a008d Dark mode, 2b50442 Merge branch 'main' of https://github.com/tgmstudios/foligo, 893cac6 updates, 8b7636e Merge branch 'main' of https://github.com/tgmstudios/foligo, 8fa9517 initial api and dash, 957db5a Merge branch 'main' of https://github.com/tgmstudios/foligo, 9c1c8f0 markdown cooking, b62c0de final sync (+4 more)

### Community 30 - "Community 30"
Cohesion: 0.16
Nodes (14): 0c81bd9 fix: CI auto-deploy with latest tag, kanban drag, AI CMS Gemini fallback, GoApply branding, 241e6c0 fix: kanban drag-save with local reactive columns + add extension to repo, 87b45fd fix(extension): make autofill and job tracking more reliable, 8f85d95 fix: CI auto-deploy with latest tag, kanban drag, AI CMS Gemini fallback, GoApply branding, 9e48065 fix: kanban drag-save with local reactive columns + add extension to repo, aa225ca fix(extension): make autofill and job tracking more reliable, GoApplyAPI, Banners (+6 more)
...
Cohesion: 0.12
Nodes (6): 19d43b2 fix(api): clean up cover letter PDFs on delete, describe LaTeX to the assistant, 347793b refactor(dashboard): always sync Content Studio preview scroll with editor, 532eb3c fix(dashboard): make the Studio preview toggle reachable on mobile, add collapsible chat, 6fbbcc1 fix(dashboard): make the Studio preview toggle reachable on mobile, add collapsible chat, b0924e1 refactor(dashboard): always sync Content Studio preview scroll with editor, ee19071 fix(api): clean up cover letter PDFs on delete, describe LaTeX to the assistant

### Community 39 - "Community 39"
Cohesion: 0.12
Nodes (11): b964476 feat(extension): rebuild browser agent on a session-scoped side panel, CDP, fs, path, REQUIRED_TOOLS, vm, loadEnvForm(), toggleCustomFields() (+3 more)
...
Cohesion: 0.15
Nodes (6): 2f47ee3 fix: make arm64 document builds reliable, 8142523 feat: add extension AI agent workflow, c34468d fix: make arm64 document builds reliable, AgentController, Filler, Finder

### Community 47 - "Community 47"
Cohesion: 0.32
Nodes (4): 3f7125f A lot of new stuff, 97e0c8d A lot of new stuff, b75351a temp, f81a378 temp

### Community 48 - "Community 48"
Cohesion: 0.15
Nodes (13): createCoverLetterEditorTools(), { createPullPageTool }, { createWebSearchTool }, { tool }, { z }, { createPullPageTool }, createResumeEditorTools(), { createWebSearchTool } (+5 more)
...
Cohesion: 0.20
Nodes (9): AI_RESUME_CHATBOT_TOOLS, _coreFoligoBaseTools(), createContentCreateTools(), createContentEditTools(), { createGithubTools }, { createPullPageTool }, { tool }, { z } (+1 more)
...
Cohesion: 0.36
Nodes (8): 2d971a7 feat(analytics): add hosted tracking script and dashboard embed snippet, a2c260b fix: handle stale PDF paths after server restart, a75b95c feat(sites): add analytics tracking plugin with fingerprinting and flow tracking, detectDeviceType(), parseBrowser(), parseOS(), send(), trackPageView()
...
Cohesion: 0.40
Nodes (1): 5561a3a feat(api): add GitHub account integration and repo-crawling AI tools
...
## Knowledge Gaps
- **679 isolated node(s):** `content_links`, `sso_providers`, `ai_models`, `voice_providers`, `platform_settings` (+674 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 20`** (1 nodes): `GeminiService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (1 nodes): `AIManager`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 64`** (1 nodes): `SiteApiService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 83`** (1 nodes): `declaration`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 95`** (1 nodes): `TemplateSelector`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 98`** (1 nodes): `5561a3a feat(api): add GitHub account integration and repo-crawling AI tools`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 106`** (2 nodes): `platform_settings`, `f0b501b feat: add web_search tool to all Foligo agents + admin settings`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 109`** (2 nodes): `user_integrations`, `users`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 110`** (2 nodes): `Chrome Extension (GoApply)`, `Job Tracker (GoApply)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 111`** (2 nodes): `Docker Deployment`, `MinIO Media Storage`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 112`** (2 nodes): `JWT Authentication`, `SSO/OAuth Authentication`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 113`** (2 nodes): `PostgreSQL Database`, `Prisma ORM`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 114`** (2 nodes): `Rate Limiting`, `Redis Caching`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `prisma` connect `Community 1` to `Community 58`, `Community 9`, `Community 11`, `Community 69`, `Community 6`, `Community 5`, `Community 7`, `Community 70`, `Community 28`, `Community 65`, `Community 66`, `Community 3`, `Community 18`, `Community 25`, `Community 10`, `Community 22`, `Community 94`, `Community 56`, `Community 34`, `Community 80`, `Community 16`, `Community 19`, `Community 2`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `GeminiService` connect `Community 20` to `Community 28`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `AIManager` connect `Community 44` to `Community 55`?**
