...
- Excluded: 4 untracked · 122046 ignored · 1 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `c6e4132`
...
Cohesion: 0.04
Nodes (63): 0702c3b fix(sse): prevent QUIC/HTTP3 connection drops on long AI responses, 3a97bc9 fix(ai): fix undefined sendSse/cleanup crash in all SSE chat routes, 40a5f9c feat: bump all agent maxSteps from 6-8 to 30-40 turns, b5a50cc fix(latex): parse tectonic inline error format + detect microtype/XeTeX conflict, ai, { body, validationResult }, { cache }, chatUpload (+55 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (51): { cache }, express, geminiService, { prisma }, router, 07b32b9 refactor(api): reorganize routes/ into domain subfolders, 4bdce87 refactor(api): reorganize services/ into domain subfolders, { authorizeProjectAccess } (+43 more)
...
Cohesion: 0.05
Nodes (47): { authorizeProjectAccess }, { body }, { cache }, express, { getContentWithAccess, invalidateContentCache }, { handleValidation }, { prisma }, router (+39 more)
...
Cohesion: 0.04
Nodes (41): AI Integration, ElevenLabs Voice, AI Function Calling, Google Gemini AI, Resume Chatbot, Resume Generator, Voice Webhook, express (+33 more)
...
Cohesion: 0.11
Nodes (11): 089f74b Refresh AI-edited posts and experience roles, 09d09b4 feat(ai): add attachment support across editors, raise agent token budgets, 1463ae4 feat(ai): give AI Content Creator full portfolio control, 19d3d7b Update portable graphify artifacts, 9fde3b9 Refresh views after AI content changes, a446f43 feat(dashboard): rebuild Job Assistant as a session workspace on shared agentic chat, cf26e1d feat(ai): extend AI Content Creator to GoApply and add current-page awareness, d082103 feat(dashboard): rebuild Job Assistant as a session workspace on shared agentic chat (+3 more)
...
Cohesion: 0.24
Nodes (4): 170fb21 fix: allow empty experience role end dates, 6ac3765 fix: resume scoring timeout - use QUICK model + aiApi (180s timeout), 76096a9 feat: add HackerRank resume scoring to resume studio, ef3bc25 fix: persist AI chats and resume scores
...
Cohesion: 0.33
Nodes (5): ai_chat_sessions, users, 38dc01a fix(dashboard): remove AI studio test animation, 8bbadc1 Add persistent AI chat sessions and analytics updates, b611ae7 feat(ai): add pull page tool to content creator
...
## Knowledge Gaps
- **691 isolated node(s):** `content_links`, `sso_providers`, `ai_models`, `voice_providers`, `platform_settings` (+686 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 18`** (1 nodes): `GeminiService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 30`** (2 nodes): `declaration`, `2533f8f feat(editor-studio): rich compile errors + LaTeX/markdown linting`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 43`** (1 nodes): `AIManager`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 60`** (1 nodes): `SiteApiService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 91`** (1 nodes): `TemplateSelector`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 106`** (2 nodes): `user_integrations`, `users`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 107`** (2 nodes): `resume_documents`, `resume_score_results`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `prisma` connect `Community 4` to `Community 54`, `Community 12`, `Community 14`, `Community 66`, `Community 24`, `Community 79`, `Community 10`, `Community 67`, `Community 25`, `Community 63`, `Community 64`, `Community 3`, `Community 16`, `Community 23`, `Community 6`, `Community 33`, `Community 21`, `Community 90`, `Community 46`, `Community 34`, `Community 76`, `Community 9`, `Community 8`, `Community 70`, `Community 2`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `GeminiService` connect `Community 18` to `Community 25`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `AIManager` connect `Community 43` to `Community 51`?**
