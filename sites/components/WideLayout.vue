  ...
  <div class="min-h-screen bg-slate-900 text-slate-100">
    ...
    <main class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <article class="prose prose-xl max-w-none">
        <header class="mb-8">
          <h1 class="text-5xl font-bold text-white mb-4">{{ props.contentData.title || 'Untitled' }}</h1>
          ...
          <p v-if="props.contentData.excerpt" class="text-2xl text-slate-200">{{ cleanExcerpt }}</p>
        </header>
