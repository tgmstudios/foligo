  ...
  <div class="min-h-screen bg-white">
      ...
      <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center py-4">
          ...
          <nav class="flex space-x-6">
            ...
            <NuxtLink to="/blog" class="text-gray-600 hover:text-gray-900 text-sm">Blog</NuxtLink>
    ...
    <main class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <article class="prose prose-lg max-w-none">
        <header class="mb-8">
          <h1 class="text-3xl font-bold text-gray-900 mb-4">{{ props.contentData.title }}</h1>
          ...
          <p v-if="props.contentData.excerpt" class="text-lg text-gray-600">{{ props.contentData.excerpt }}</p>
        </header>
