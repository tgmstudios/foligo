      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
        ...
        <div v-if="currentStep === 1" class="p-8">
          <div class="text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div class="text-center">
                <div class="mx-auto h-12 w-12 bg-blue-100 dark:bg-blue-900 rounded-lg flex items-center justify-center mb-3">
                  <svg class="h-6 w-6 text-blue-600 dark:text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                  </svg>
                </div>
                <h3 class="font-semibold text-gray-900 dark:text-white">Create Projects</h3>
                <p class="text-sm text-gray-600 dark:text-gray-400">Organize your work into projects</p>
              </div>
              
              <div class="text-center">
                <div class="mx-auto h-12 w-12 bg-green-100 dark:bg-green-900 rounded-lg flex items-center justify-center mb-3">
                  <svg class="h-6 w-6 text-green-600 dark:text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                  </svg>
                </div>
                <h3 class="font-semibold text-gray-900 dark:text-white">Manage Content</h3>
                <p class="text-sm text-gray-600 dark:text-gray-400">Add and organize your content</p>
              </div>
              
              <div class="text-center">
                <div class="mx-auto h-12 w-12 bg-purple-100 dark:bg-purple-900 rounded-lg flex items-center justify-center mb-3">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">Get AI-powered insights</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div v-if="currentStep === 2" class="p-8">
          <div class="text-center mb-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Create Your First Project</h2>
        ...
        <div v-if="currentStep === 3" class="p-8">
          <div class="text-center mb-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Choose a Template</h2>
            <p class="text-gray-600 dark:text-gray-400">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              <div class="aspect-video bg-gray-100 dark:bg-gray-600 rounded-md mb-3 flex items-center justify-center">
                <div class="text-center">
                  <div class="text-4xl mb-2">{{ template.icon }}</div>
                  <div class="text-sm text-gray-600 dark:text-gray-300">{{ template.name }}</div>
                </div>
              </div>
        ...
        <div v-if="currentStep === 4" class="p-8">
          <div class="text-center mb-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Set Your Preferences</h2>
            <p class="text-gray-600 dark:text-gray-400">
            ...
            <div>
              ...
              <div class="space-y-2">
                <label v-for="focus in focusAreas" :key="focus.id" class="flex items-center">
                  ...
                  />
                  <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">{{ focus.name }}</span>
                </label>
              </div>
            </div>
        ...
        <div v-if="currentStep === 5" class="p-8 text-center">
          <div class="mx-auto h-16 w-16 bg-success-100 dark:bg-success-900 rounded-full flex items-center justify-center mb-6">
            <svg class="h-8 w-8 text-success-600 dark:text-success-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
            </svg>
          </div>
          <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">You're All Set!</h2>
